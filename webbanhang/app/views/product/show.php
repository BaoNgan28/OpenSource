                ...
                <?php if (SessionHelper::isAdmin()): ?>
                    <div class="d-flex gap-2">
                        <a href="/webbanhang/Product/edit/<?php echo $product->id; ?>" 
                           class="btn btn-outline-warning btn-action-round shadow-sm" style="padding: 12px 18px; border-radius: 50%;" title="Chỉnh sửa">
                            <i class="bi bi-pencil-square fs-5"></i>
                        </a>
                        <a href="/webbanhang/Product/delete/<?php echo $product->id; ?>" 
                           class="btn btn-outline-danger btn-action-round shadow-sm" style="padding: 12px 18px; border-radius: 50%;"
