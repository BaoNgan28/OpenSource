        ...
        <div class="p-5 text-white rounded-4 shadow-sm" style="background: linear-gradient(135deg, #6a11cb 0%, #2575fc 100%);">
            <div class="row align-items-center">
                <div class="col-md-8 text-center text-md-start">
                    <h1 class="display-4 fw-bold">Sản phẩm hiện đại mỗi ngày<br><br></h1>
                    <p class="lead mb-4">Khám phá menu đa dạng các loại sản phẩm tại My Store.</p>
                    <div class="d-flex gap-2 justify-content-center justify-content-md-start">
                        <a href="/webbanhang/Category/index" class="btn btn-light btn-lg px-4 rounded-pill fw-bold text-primary">Danh mục</a>
...
<div id="store-section" class="row mb-4 align-items-center">
