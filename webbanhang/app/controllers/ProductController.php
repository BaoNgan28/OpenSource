...
class ProductController
{
    ...
    public function index()
    {
        ...
        // QUAN TRỌNG: Bắt ID danh mục từ URL mà Header vừa gửi tới
        $category_id = $_GET['category_id'] ?? null;

        // Truyền cả 2 vào Model để lấy danh sách sản phẩm đã lọc
        $products = $this->productModel->getProducts($searchTerm, $category_id);
    ...
    // Hàm cập nhật số lượng hoặc xóa sản phẩm (Tùy chọn thêm để web chuyên nghiệp hơn)
    ...
    public function processCheckout()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($orderModel->createOrder($name, $phone, $address, $cart)) {
